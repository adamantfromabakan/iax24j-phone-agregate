...
public class Connection implements Runnable {
    ...
    static final int IAX_PORT = 14570;
    ...
    public void start(Peer peer, String host) {
        ...
        try {
            ...
            //socket.setSoTimeout(2000); // timeout on recv 2 sec
    ...
    public synchronized void stop() {
        running = false;
        socket.close(); // interrupt any bloked socket.receive
    }
    ...
    public void run() {
        while (running) {
            try {
                ...
                // do nothing, this is expected when the socket is being closed
